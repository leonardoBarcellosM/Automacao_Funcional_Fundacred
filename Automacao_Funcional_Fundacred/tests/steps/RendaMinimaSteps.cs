...
namespace Automacao_Funcional_Fundacred.tests.steps
{
    ...
    public class RendaMinimaSteps
    {
        ...
        public void GivenInformoValorInferiorAoMinimo()
        {
            ...
            Assert.True(result, "Erro ao inserir valor no campo Renda mensal bruta");
        }
        ...
        public void ThenApresentaMensagemInformandoQueOValorEInsuficiente()
        {
            ...
            Assert.True(result, "Erro ao apresentar a mensagem informando que o valor é insuficiente");
        }
        ...
        public void ThenOBotaoEnviarFicaraDesabilitado()
        {
            ...
            Assert.True(result, "Erro ao apresentar o botao enviar desabilitado");
        }
        ...
        public void ThenAOpcaoQueroContinuarMesmoAssimEApresentada()
        {
            ...
            Assert.True(result, "Erro ao apresentar o botão quero continuar mesmo assim");
        }
        ...
        public void GivenInformoValorSuperiorAoMinimo()
        {
            ...
            Assert.True(result, "Erro ao inserir o valor no campo Renda Mensal Bruta");
        }
        ...
        public void ThenApresentaMensagemInformandoQueOValorESuficiente()
        {
            ...
            Assert.True(result, "Erro ao apresentar a mensagem informando que o valor é suficiente");
        }
        ...
        public void ThenApresentaMensagemInformandoQueOValorESuficienteParaDoisFiadores()
        {
            ...
            Assert.True(result, "Erro ao apresentar a mensagem informando que o valor é suficiente para dois fiadores");
        }
        ...
        public void ThenOBotaoEnviarFicaraHabilitado()
        {
            ...
            Assert.True(result, "Erro ao apresentar o botao Enviar habilitado");
        }
        ...
        public void GivenInformoAMetadeDoValorComOPrimeiroFiador()
        {
            ...
            Assert.True(result, "Erro ao informar a renda mensal bruta do primeiro fiador");
        }
        ...
        public void WhenSelecionoAOpcaoParaInformarUmSegundoFiador()
        {
            ...
            Assert.True(result, "Erro ao selecionar a opção para informar um segundo fiador");
        }
        ...
        public void WhenInformoValorInferiorAoMinimoComOSegundoFiador()
        {
            ...
            Assert.True(result, "Erro ao informar a renda mensal bruta do segundo fiador");
        }
        ...
        public void ThenApresentaMensagemInformandoQueOValorEInsuficienteParaOsDoisFiadores()
        {
            ...
            Assert.True(result, "Erro ao apresentar a mensagem informando que o valor e insuficiente para dois fiadores");
        }
        ...
        public void ThenAOpcaoQueroContinuarMesmoAssimEApresentadaParaOsDoisFiadores()
        {
            ...
            Assert.True(result, "Erro ao apresentar o botao quero continuar mesmo assim para dois fiadores");
        }
        ...
        public void GivenRemovoOSegundoFiador()
        {
            ...
            Assert.True(result, "Erro ao remover o segundo fiador");
        }
        ...
        public void WhenClicoNoCheckboxParaContinuarMesmoAssim()
        {
            ...
            Assert.True(result, "Erro ao selecionar a opcao quero continuar mesmo assim");
        }
